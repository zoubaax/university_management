...
router
    .route('/')
    .get(authorize('SUPER_ADMIN', 'RH', 'RESPONSABLE_DEPARTMENT', 'DIRECTOR_DEPARTMENT', 'PROFESSOR'), getEmployees)
    .post(
...
router
    .route('/:id')
    .get(authorize('SUPER_ADMIN', 'RH', 'RESPONSABLE_DEPARTMENT', 'DIRECTOR_DEPARTMENT', 'PROFESSOR'), getEmployee)
