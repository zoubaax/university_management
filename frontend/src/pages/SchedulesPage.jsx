...
const SchedulesPage = () => {
    ...
    const filteredClasses = useMemo(() => {
        ...
        return classes.filter(c => c.speciality_id === selectedSpeciality);
    }, [classes, selectedSpeciality]);
    ...
    const getScheduleForSlot = (day, slotType) => {
        return schedules.find(s => s.day_of_week === day && s.slot_type === slotType);
    };
            ...
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Select a class to view or manage its weekly schedule</p>
                    </div>
